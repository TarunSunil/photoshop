...
- The full product spec is larger than one pass. Build order stays aligned to app shell, image loading/rendering, non-destructive model, adjustments/export, masking, then local AI.
